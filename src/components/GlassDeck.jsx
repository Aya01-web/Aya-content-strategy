...
const cards = [
  {
    ...
    desc: 'Digital product content covering home healthcare, remote medical consultations, and at-home health monitoring services.',
    image: narImage,
    href: 'https://www.naraakum.com/',
    openLabel: 'Open Naraakum website'
  },
  {
    id: 'qqs',
    title: 'QQS',
    badge: 'EdTech Product Content',
    desc: 'Product-focused content for a university assessment platform with AI-powered exam security and management features.',
    image: qqsImage,
    href: 'https://www.qqassessment.com/',
    openLabel: 'Open QQS website'
  },
  {
    id: 'his',
    title: 'HIS',
    badge: 'B2B Product Content',
    desc: 'Clear product content explaining healthcare center operations, insurance integration, and end-to-end billing solutions.',
    image: hisImage,
    href: null,
    openLabel: 'HIS content preview'
  },
  {
    id: 'mospkat',
    title: 'Mospkat',
    badge: 'Educational Content & Blogs',
    desc: 'Educational content and blog topics for children’s global competitions, preparation courses, and competition exams.',
    image: mospkatImage,
    href: 'https://www.musabakat.com/ar/index',
    openLabel: 'Open Mospkat website'
  },
  {
    id: 'sytar',
    title: 'Sytar',
    badge: 'Mental Health Content',
    desc: 'Service-focused content that makes mental health support easier to understand for clients and healthcare professionals.',
    image: sytarImage,
    href: 'https://www.psyter.com/en/home-page',
    openLabel: 'Open Sytar website'
  }
];
...
export default function GlassDeck() {
  ...
  return (
    <section className="fanDeckSection" id="latest-content" aria-labelledby="latestContentTitle">
      <div className="fanDeckWrap">
        <header className="fanDeckHeader">
          <h2 id="latestContentTitle">Latest Digital Product Content &amp; Blogs</h2>
          <p>
            Explore selected product content and blog work across healthcare,
            education, and digital service websites.
          </p>
        </header>
