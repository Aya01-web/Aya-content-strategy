...
import ataaFundLogo from '../assets/company-work/ataa-fund.png';
import beautyStarLogo from '../assets/company-work/beauty-star.jpg';
import emerlyPerfumesLogo from '../assets/company-work/emerly-perfumes.jpg';
import mensClubLogo from '../assets/company-work/mens-club.jpg';
...
const timelineItems = [
  {
    category: 'work',
    title: 'Social Media Content Strategist — InnoTech',
    date: '2024 – 2026 · 2 Years',
    bullets: [
      'Implemented social media content plans and channel strategies aligned with brand and product goals.',
      'Managed the official Instagram, TikTok, X (Twitter), and Facebook accounts.',
      'Collaborated with the creative and product teams to plan, produce, and publish high-impact content.',
      'Built automated content workflows and calendars, with monthly performance reports and results analysis.'
    ]
  },
  {
    category: 'work',
    title: "Community Manager & Content Strategist — Men's Club",
    date: '2023 – 2024 · 1 Year',
    bullets: [
      'Developed marketing and content strategies for an e-commerce fashion brand.',
      'Managed the online community, audience engagement, and day-to-day brand conversations across social channels.'
    ]
  },
  {
    category: 'work',
    title: 'Technical Support, Business Development & Lead Manager — Ataa Fund',
    date: 'Mar 2023 – Aug 2023 · Part-Time · 6 Months',
    bullets: [
      'Supported day-to-day technical needs while contributing to business development initiatives.',
      'Managed leads, coordinated follow-ups, and helped turn audience interest into meaningful relationships.'
    ]
  },
  {
    category: 'work',
    title: 'Social Media Specialist & Business Development — Beauty Star',
    date: '2022 – 2023 · 1 Year',
    bullets: [
      'Planned and managed social media content for a fashion-focused audience.',
      'Supported business development through audience insights, customer engagement, and brand growth opportunities.'
    ]
  },
  {
    category: 'work',
    title: 'Operations Management & Social Media Moderator — Emerly Perfumes',
    date: 'Mar 2022 – Jun 2022',
    bullets: [
      'Coordinated daily operations and supported smooth customer-facing workflows.',
      'Moderated social media conversations and maintained timely, brand-aligned customer communication.'
    ]
  }
];
...
const workedWithCompanies = [
  ...
  },
  {
    id: 'beauty-star',
    name: 'Beauty Star',
    asset: beautyStarLogo
  },
  {
    id: 'emerly-perfumes',
    name: 'Emerly Perfumes',
    asset: emerlyPerfumesLogo
  }
];
...
const bulletVariants = {
  ...
  show: {
    opacity: 1,
    y: 0,
    transition: { duration: 0.48, ease: ROAD_EASE }
  }
};
      ...
      <div className="timeline-shell">
        ...
        >
          ...
          <p className="timeline-subtitle">
            A journey through content strategy, community building, social media, and
            brand growth across technology, e-commerce, fashion, nonprofit, and beauty.
          </p>
        </motion.header>
        ...
        <div className="timeline-road">
          <div className="timeline-road-visual" aria-hidden="true" ref={roadVisualRef}>
            <svg className="timeline-road-svg" viewBox="0 0 100 1040" preserveAspectRatio="none" ref={roadSvgRef}>
              <defs>
                <linearGradient id="timeline-road-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                  ...
                  <stop offset="48%" stopColor="#38c8ff" />
            ...
            <span ref={carRef} className="timeline-road-vehicle">
              ...
              <span className="timeline-road-jet-shell">
                <img
                  className="timeline-road-jet"
                  src={planeImage}
                  alt=""
                  loading="lazy"
                  decoding="async"
                  fetchPriority="low"
                />
                <span className="timeline-road-jet-mark">A</span>
              </span>
            </span>
          </div>
                ...
                <li className={`timeline-item ${sideClass}`} key={item.title}>
                  <span className="timeline-node-col" aria-hidden="true">
                    <motion.span
                      ...
                      transition={{
                        duration: reduceMotion ? 0.25 : 2.6,
                  ...
                  <motion.article
                    ...
                    initial={reduceMotion ? false : { opacity: 0, y: 32, scale: 0.985, filter: 'blur(6px)' }}
                    whileInView={{ opacity: 1, y: 0, scale: 1, filter: 'blur(0px)' }}
                    viewport={{ once: true, amount: 0.26 }}
                    transition={{ duration: 0.82, delay: cardDelay, ease: ROAD_EASE }}
                  >
